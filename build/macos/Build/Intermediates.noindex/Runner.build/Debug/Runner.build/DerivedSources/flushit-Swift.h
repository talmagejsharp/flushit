...
#ifndef FLUSHIT_SWIFT_H
#define FLUSHIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flushit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7flushit11AppDelegate")
...
SWIFT_CLASS("_TtC7flushit17MainFlutterWindow")
