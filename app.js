...
app.use(cors({
    credentials: true,
    origin: 'http://localhost:52574' //I'm having some trouble with CORS so let's try disabling this line
}));
...
app.post('/login', async (req, res) => {
  ...
  console.log("successfullly signed in and sent the jwt token " + token);
